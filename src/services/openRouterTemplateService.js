...
const fieldSchema = { type: "object", additionalProperties: false, required: ["fieldKey", "label", "fieldType", "required", "sectionKey", "sourceOrder", "options", "sourceText", "evidenceRefs", "confidence", "warning"], properties: { fieldKey: { type: "string" }, label: { type: "string" }, fieldType: { enum: [...FIELD_TYPES] }, required: { type: "boolean" }, sectionKey: { type: "string" }, sourceOrder: { type: "integer" }, options: { type: "array", items: { type: "string" } }, sourceText: { type: "string" }, evidenceRefs: evidenceRefSchema, confidence: { type: "number", minimum: 0, maximum: 1 }, warning: { type: "string" } } };
